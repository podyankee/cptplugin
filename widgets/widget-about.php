...
class Aletheme_About_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__('A widget that displays a short information about you.', 'ale')
		);
		...
		/* Create the widget. */
		parent::__construct( 'ale_about_widget', esc_html__('Aletheme About Me', 'ale'), $widget_ops, $control_ops );
	}
