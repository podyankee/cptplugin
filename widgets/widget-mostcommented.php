...
class Aletheme_Mostcommented_Widget extends WP_Widget
{
    ...
    <div class="aletheme-mostcommented-widget">
        <div class="ale_items_blog cf">
            ...
            <?php  if (get_the_post_thumbnail(get_the_ID())) :  ?>
						<div class="cf ale_item_blog mostcommentedpost">
                            ...
                            <div class="detail">
                                ...
                                <span class="entry-meta">
                                    <?php printf(_n('One comment', '%1$s Comments', get_comments_number(), 'ale'), number_format_i18n(get_comments_number())); ?>
                                </span>
                            </div>
                        </div>
                <?php else: ?>
					    <div class="cf ale_item_blog no-thumb">
                            <div class="detail">
                                <h4 class="entry-title">
                                    <a class="whitelink" href="<?php the_permalink(); ?>">
                                        <span class="title"><?php the_title(); ?></span>
    ...
    public function form( $instance )
    {
        ...
        $defaults = array(
            'title' => esc_html__('Most Commented', 'ale'),
            'number' => 3
        );
