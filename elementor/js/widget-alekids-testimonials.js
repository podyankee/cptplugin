(function ($) {
	$(window).on('elementor/frontend/init', function () {
		elementorFrontend.hooks.addAction(
			'frontend/element_ready/alekids_testimonials.default',
			function ($scope, $) {
				('use strict');
					...
					(e = (function () {
						...
						(e.prototype.getDotCount = function () {
							...
							if (!0 === i.options.infinite)
								...
								o =
									1 + Math.ceil((i.slideCount - i.options.slidesToShow) / i.options.slidesToScroll);
							return o - 1;
						}),
